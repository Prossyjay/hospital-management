...
include('post_con/waste-water_con.php');
?>
<!DOCTYPE html>
<html lang="en">
                                        ...
                                        <div class="panel panel-white">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form role="form" name="book" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="checklistspace_condition">
                                                            Space is clean and in good condition
                                                        </label>
                                                        <select name="space_condition" class="form-control" value="<?php echo ($space_condition) ?>">
                                                            <option value="Yes"> Yes</option>
                                                            <option value="No"> No</option>
                                                            <option value="N/A"> N/A</option>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="checklistwater_valve">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="checklistelectrical_contacts">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="checklistwater_leakage">
                                                            No water leakage
                                                        </label>
